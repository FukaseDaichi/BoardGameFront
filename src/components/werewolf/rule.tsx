    ...
    <div className={styles.rule} onClick={props.endFnc}>
      <div>
        <div>
          ...
          + １
          の好きな役職を設定ボタンで設定してください。また、議論時間を３分間などあらかじめ決定してください。
          <br />
          「おすすめセット」では、おすすめな役職配分を設定できます！
          <br />
          ※役職の数が参加者多い場合、役欠け（プレイヤーに配られれない役職）が発生します。全ての「人狼」が役欠けになることはありません。
          <h2>役職選択</h2>
          任意に順番が決定します。スタートプレイヤーには２つ、他のプレイヤーには１つの役職が配られます。
          <br />
          プレイヤーは２つの役職から好きな役職を選び、残った役職を次のプレイヤーに渡します。最後のプレイヤーの残った役職が「ＮＰＣ」の役職となります。
          <br />
          この時の情報は全て「初めに配られた役職」「渡された役職」「選んだ役職」は議論時間で好きに話せます。忘れないようにしてください。
          <h2>議論</h2>
          あらかじめ設定した時間内で議論します。時間が来たら終了ボタンで議論を終了してください。
          この時一部の役職は特殊能力を使用することができます。
          <h2>投票</h2>
